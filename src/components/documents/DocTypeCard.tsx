  ...
  return (
    <div onClick={handleClick} style={{ textDecoration: "none" }}>
      <div style={{
        ...
        <div style={{
          width: 44, height: 44, borderRadius: 8, background: tokens.color.bgSunken,
        ...
        <div style={{ position: "relative", flex: 1 }}>
          <div style={{ fontSize: 16, fontWeight: 500, color: tokens.color.text, letterSpacing: "-0.02em", marginBottom: 6 }}>{name}</div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: "12px", color: tokens.color.textSubtle }}>{count} modelos</span>
          <div style={{
