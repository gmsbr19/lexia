// LexIA · Controles de Visão — ícones (lucide-style, stroke). Port fiel do protótipo.
import React from "react";

export type VgIconName =
  | "fileText" | "chevronDown" | "chevronRight" | "chevronLeft" | "check" | "checkCircle"
  | "x" | "plus" | "minus" | "search" | "filter" | "sliders" | "layoutGrid" | "sidebar"
  | "download" | "list" | "menu" | "kanban" | "funnel" | "users" | "user" | "building"
  | "star" | "edit" | "copy" | "trash2" | "refreshCw" | "gripVertical" | "cornerDownRight"
  | "braces" | "alertCircle" | "sigma" | "wand" | "calendar" | "eye" | "sun" | "moon"
  | "clock" | "inbox" | "alertTriangle" | "wifiOff" | "target" | "megaphone" | "handshake"
  | "globe" | "flag" | "circleDot" | "flame" | "sunrise" | "percent" | "banknote"
  | "userPlus" | "gitMerge" | "moreHorizontal" | "upload" | "fileSpreadsheet" | "repeat";
...
export function Icon({
  ...
  switch (name) {
    ...
    case "wand":
      return (<svg {...p}><path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 11.8 19 13"/><path d="M15 9h0"/><path d="M17.8 6.2 19 5"/><path d="m3 21 9-9"/><path d="M12.2 6.2 11 5"/></svg>);
    case "edit":
      return (<svg {...p}><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/></svg>);
    case "download":
    ...
    case "sidebar":
      return (<svg {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg>);
    case "sun":
    ...
    case "sigma":
      return (<svg {...p}><path d="M18 7V4H6l6 8-6 8h12v-3"/></svg>);
    case "circleDot":
      return (<svg {...p}><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="1" fill="currentColor"/></svg>);
    case "alertTriangle":
    ...
    case "banknote":
      return (<svg {...p}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>);
    case "flag":
    ...
    case "kanban":
      return (<svg {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg>);
    case "repeat":
      return (<svg {...p}><path d="m17 2 4 4-4 4"/><path d="M3 11v-1a4 4 0 0 1 4-4h14"/><path d="m7 22-4-4 4-4"/><path d="M21 13v1a4 4 0 0 1-4 4H3"/></svg>);
    case "gripVertical":
      return (<svg {...p} fill="currentColor" stroke="none"><circle cx="9" cy="6" r="1.4"/><circle cx="9" cy="12" r="1.4"/><circle cx="9" cy="18" r="1.4"/><circle cx="15" cy="6" r="1.4"/><circle cx="15" cy="12" r="1.4"/><circle cx="15" cy="18" r="1.4"/></svg>);
    case "cornerDownRight":
      return (<svg {...p}><polyline points="15 10 20 15 15 20"/><path d="M4 4v7a4 4 0 0 0 4 4h12"/></svg>);
    case "x":
    ...
    case "trash2":
      return (<svg {...p}><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>);
    case "sunrise":
      return (<svg {...p}><path d="M12 2v8"/><path d="m4.93 10.93 1.41 1.41"/><path d="M2 18h2"/><path d="M20 18h2"/><path d="m19.07 10.93-1.41 1.41"/><path d="M22 22H2"/><path d="m8 6 4-4 4 4"/><path d="M16 18a4 4 0 0 0-8 0"/></svg>);
    case "megaphone":
    ...
    case "funnel":
      return (<svg {...p}><path d="M3 4h18l-7 8v7l-4-2v-5z"/></svg>);
    case "fileSpreadsheet":
      return (<svg {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h2"/><path d="M14 13h2"/><path d="M8 17h2"/><path d="M14 17h2"/></svg>);
    case "braces":
      return (<svg {...p}><path d="M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5a2 2 0 0 0 2 2h1"/><path d="M16 21h1a2 2 0 0 0 2-2v-5a2 2 0 0 1 2-2 2 2 0 0 1-2-2V5a2 2 0 0 0-2-2h-1"/></svg>);
    case "wifiOff":
      return (<svg {...p}><path d="M12 20h.01"/><path d="M8.5 16.42a5 5 0 0 1 7 0"/><path d="M5 13a10 10 0 0 1 5.24-2.76"/><path d="M10.66 5c4.01-.36 8.14.9 11.34 3.76"/><path d="M16.85 11.25a10 10 0 0 1 2.22 1.68"/><path d="M2 8.82a15 15 0 0 1 4.17-2.65"/><line x1="2" y1="2" x2="22" y2="22"/></svg>);
    case "gitMerge":
      return (<svg {...p}><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 21V9a9 9 0 0 0 9 9"/></svg>);
    default:
      return null;
  }
}
