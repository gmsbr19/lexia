...
export const comercialTools = [
  ...
  defineTool({
    ...
    run: async (ctx, i) =>
      converterLead(
        i.id,
        { clienteId: i.clienteId, casoId: i.casoId, honorarioId: i.honorarioId, valorContratadoCents: i.valorContratadoCents, tipoHonorario: i.tipoHonorario, clienteNome: i.clienteNome, casoTitulo: i.casoTitulo, dataConversao: i.dataConversao },
        ctx.user.email,
      ),
  }),
  defineTool({
