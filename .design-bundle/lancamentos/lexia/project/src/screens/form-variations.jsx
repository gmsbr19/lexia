  ...
  <div style={{
    ...
    <div style={{ flex: 1 }}>
      <div style={{
        ...
        <div style={{ fontSize: 11.5, color: 'var(--text-muted)', fontWeight: 500 }}>Progresso</div>
        <div style={{ fontSize: 11.5, color: 'var(--text-subtle)', fontFeatureSettings: '"tnum"' }}>
          11 campos pendentes
        </div>
      </div>
      <div style={{
...
const V2Settings = () => (
  <Frame footerPct={24}>
    ...
    <GroupTitle>
      <span style={{ fontSize: 13.5, color: 'var(--text-muted)', fontWeight: 600 }}>Endereço</span>
    </GroupTitle>
