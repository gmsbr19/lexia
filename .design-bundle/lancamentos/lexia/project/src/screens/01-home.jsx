  ...
  <div className="card" style={{
    ...
    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
        ...
        <span style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--text-subtle)' }}>
          {type}
        </span>
      </div>
      {source === 'ai' && (
...
const QuickTemplateCard = ({ name, type, usedCount }) => (
  <div className="card" style={{
    ...
    <div style={{
      ...
      <span style={{ fontSize: 7.5, fontWeight: 700, letterSpacing: '0.04em', color: '#020D25', fontFamily: 'var(--font-mono)' }}>
...
const TypeCardMini = ({ icon, name, count }) => (
  <div style={{
    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      <div style={{ fontSize: 13.5, fontWeight: 600, color: 'var(--text)', letterSpacing: '-0.015em' }}>
        {name}
      </div>
...
const SectionHeader = ({ title, subtitle, action }) => (
  <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 14, gap: 16 }}>
    <div>
      <h2 style={{ margin: 0, fontSize: 14.5, fontWeight: 600, letterSpacing: '-0.015em', color: 'var(--text)' }}>
        {title}
      </h2>
      {subtitle && (
        <div style={{ fontSize: 11.5, color: 'var(--text-subtle)', marginTop: 2 }}>{subtitle}</div>
      )}
    </div>
    {action && (
  ...
  >
    <div style={{ padding: '32px 40px 48px', maxWidth: 1180 }}>
      ...
      <div style={{ marginBottom: 36 }}>
        ...
        <p style={{ margin: '6px 0 20px', fontSize: 13.5, color: 'var(--text-muted)', letterSpacing: '-0.005em' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{
              ...
              <button className="btn btn-ghost" style={{ height: 28, fontSize: 11.5, padding: '0 8px' }}>
              ...
              <button className="btn btn-gold" style={{ height: 30, fontSize: 12.5, padding: '0 14px' }}>
