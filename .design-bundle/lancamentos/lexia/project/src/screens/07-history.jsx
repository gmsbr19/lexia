...
const DocRow = ({ name, type, client, author, date, status, size, source }) => (
  <tr style={{ borderTop: '1px solid var(--border)' }}>
    ...
    <td style={{ padding: '12px 16px', fontSize: 12.5, color: 'var(--text-muted)' }}>{client}</td>
    ...
    <td style={{ padding: '12px 16px', fontSize: 12.5, color: 'var(--text-subtle)' }}>{date}</td>
    <td style={{ padding: '12px 16px' }}>
      <span style={{
      ...
      <div style={{
        ...
        {[
          ...
          <div key={s.label} className="card" style={{ padding: '14px 16px' }}>
            <div style={{ fontSize: 11.5, color: 'var(--text-muted)', letterSpacing: '0.01em' }}>
              {s.label}
            </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ background: 'var(--bg-soft)' }}>
              <th style={{ textAlign: 'left', padding: '10px 16px', fontSize: 10.5, fontWeight: 600, color: 'var(--text-subtle)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Documento</th>
              <th style={{ textAlign: 'left', padding: '10px 16px', fontSize: 10.5, fontWeight: 600, color: 'var(--text-subtle)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Cliente</th>
              <th style={{ textAlign: 'left', padding: '10px 16px', fontSize: 10.5, fontWeight: 600, color: 'var(--text-subtle)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Autor</th>
              <th style={{ textAlign: 'left', padding: '10px 16px', fontSize: 10.5, fontWeight: 600, color: 'var(--text-subtle)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Atualizado</th>
              <th style={{ textAlign: 'left', padding: '10px 16px', fontSize: 10.5, fontWeight: 600, color: 'var(--text-subtle)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Status</th>
              <th />
            </tr>
          </thead>
          <tbody>
