  ...
  return (
    <div style={{ position: 'relative' }}>
      <button onClick={() => setOpen((o) => !o)} style={{
        ...
        borderRadius: 9, cursor: 'pointer', fontSize: 12.5, fontWeight: 500, fontFamily: 'var(--font-sans)',
        ...
        {active && cur ? (
          <>
            ...
            <span style={{ fontWeight: 600, color: 'var(--accent)', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 128 }}>{cur.label}</span>
    ...
    <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, padding: '16px 40px 14px', flexShrink: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          {onNew && <button className="btn btn-primary" onClick={onNew} style={{ height: 34, fontSize: 12.5, padding: '0 16px' }}><Icon name="plus" size={14} />Novo lançamento</button>}
        </div>
      </div>
