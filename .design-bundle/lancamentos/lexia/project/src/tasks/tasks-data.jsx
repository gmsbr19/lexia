...
const PROJECTS = [
  ...
  { id: 'civ',   name: 'Cível & contratos',       color: '#2A6FDB' },
  { id: 'int',   name: 'Operação interna',        color: '#7A6FA8' },
];
...
const STATUS = [
  ...
  { id: 'doing',  label: 'Em andamento',  color: '#2A6FDB' },
...
const PRIO = {
  ...
  3: { label: 'Média',   short: 'P3', color: '#2A6FDB' },
