...
const CmApp = () => {
  ...
  const actions = (
    <>
      ...
      <button className="btn btn-secondary" onClick={() => openGasto()} style={{ height: 34, fontSize: 12.5 }}><Icon name="coins" size={14} />Registrar gasto</button>
      <button className="btn btn-secondary" onClick={() => openLead()} style={{ height: 34, fontSize: 12.5 }}><Icon name="userPlus" size={14} />Lead</button>
      <button className="btn btn-primary" onClick={() => openCampanha()} style={{ height: 34, fontSize: 12.5 }}><Icon name="plus" size={14} />Nova campanha</button>
    </>
  );
