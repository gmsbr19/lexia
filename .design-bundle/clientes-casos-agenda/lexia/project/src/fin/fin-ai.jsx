    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
          <span style={{ fontSize: 13, fontWeight: 500, color: 'var(--text)', letterSpacing: '-0.01em', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.title}</span>
          {item.ai && (
        ...
        <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.ctx}</div>
      </div>
  ...
  <div className="card" style={{ padding: '16px 18px' }}>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
        ...
        <div>
          <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--text)', letterSpacing: '-0.01em' }}>Próximo passo</div>
  ...
  <div style={{
    ...
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 14, paddingTop: 14, borderTop: '1px solid var(--border)' }}>
        <button className="btn btn-gold" style={{ height: 32, fontSize: 12 }}>
          <Icon name="arrowRightCircle" size={13} strokeWidth={2} />
          Ver plano de ação
        </button>
        <button className="btn btn-ghost" style={{ height: 32, fontSize: 12 }}>Pular semana</button>
        <div style={{ flex: 1 }} />
