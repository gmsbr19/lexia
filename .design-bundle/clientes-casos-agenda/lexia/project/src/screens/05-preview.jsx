...
const Letterhead = () => (
  <div style={{ borderBottom: '1px solid rgba(2,13,37,0.1)' }}>
    ...
    <div style={{
      ...
      <div>
        <div style={{ fontFamily: 'Georgia, serif', fontWeight: 500, fontSize: 16, letterSpacing: '0.02em' }}>
          MORAES &amp; ASSOCIADOS
        </div>
...
const FullDocumentPreview = () => (
  <div style={{
    ...
    <div style={{ padding: '32px 56px 32px' }}>
      ...
      <div style={{ fontWeight: 500, fontSize: 11, marginBottom: 6, letterSpacing: '0.02em' }}>
  ...
  >
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          marginTop: 14, fontSize: 12, color: 'var(--text-subtle)',
        }}>Página 1 de 3</div>
      </section>
      ...
      <aside style={{
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 11, fontWeight: 500, letterSpacing: '0.08em', color: 'var(--text-subtle)', textTransform: 'uppercase', marginBottom: 12 }}>
            Verificação
          </div>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: 'var(--accent)', fontWeight: 500, marginBottom: 6 }}>
              <Icon name="sparkles" size={12} />
              CLÁUSULA 2ª
            </div>
            <div style={{ fontSize: 12, color: 'var(--text)', lineHeight: 1.5, letterSpacing: '-0.005em', marginBottom: 10 }}>
              Considerar incluir multa por atraso (2% + juros 1% a.m.) — padrão do escritório.
            </div>
            <div style={{ display: 'flex', gap: 6 }}>
              <button className="btn btn-secondary" style={{ height: 26, fontSize: 12, padding: '0 10px' }}>Aplicar</button>
              <button className="btn btn-ghost" style={{ height: 26, fontSize: 12, padding: '0 10px' }}>Ignorar</button>
            </div>
          </div>
        </div>
