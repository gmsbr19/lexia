    ...
    <div style={{ padding: '28px 40px 40px', maxWidth: 1200 }}>
      ...
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 24 }}>
        <div>
          ...
          <p style={{ margin: '6px 0 0', fontSize: 13.5, color: 'var(--text-muted)', maxWidth: 560, lineHeight: 1.5 }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 10.5, color: 'var(--text-subtle)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Total</div>
            <div style={{ fontSize: 18, fontWeight: 600, color: 'var(--text)', letterSpacing: '-0.02em' }}>32</div>
          </div>
          <div style={{ width: 1, background: 'var(--border)' }} />
          <div>
            <div style={{ fontSize: 10.5, color: 'var(--text-subtle)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Favoritos</div>
            <div style={{ fontSize: 18, fontWeight: 600, color: 'var(--text)', letterSpacing: '-0.02em' }}>7</div>
          </div>
        </div>
      </div>
