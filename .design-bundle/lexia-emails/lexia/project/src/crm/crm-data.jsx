...
// ---- people ----
const CRM_USERS = [
  { id: 'thiago',  nome: 'Thiago Portela',     email: 'thiago@ncmadv.com.br',   role: 'admin', ativo: true, iniciais: 'TP', cargo: 'Gestão de operações', oab: '' },
  { id: 'leandro', nome: 'Leandro Nunes',      email: 'leandro@ncmadv.com.br',  role: 'socio', ativo: true, iniciais: 'LN', cargo: 'Sócio', oab: 'OAB/SP 184.221' },
  { id: 'leonardo',nome: 'Leonardo Collares',  email: 'leonardo@ncmadv.com.br', role: 'socio', ativo: true, iniciais: 'LC', cargo: 'Sócio', oab: 'OAB/SP 201.560' },
  { id: 'marina',  nome: 'Marina Castro',      email: 'marina@ncmadv.com.br',   role: 'staff', ativo: true, iniciais: 'MC', cargo: 'Advogada', oab: 'OAB/SP 312.880' },
  { id: 'rafael',  nome: 'Rafael Aguiar',      email: 'rafael@ncmadv.com.br',   role: 'staff', ativo: false, iniciais: 'RA', cargo: 'Estagiário', oab: '' },
];
...
// ---- documentos ----
// nome, modelo, formato, data, status, clienteIdx, autor, palavras
const CRM_DOCS_RAW = [
  ['Contrato de Honorários — Construtora Aurora', 'Contrato de Honorários', 'PDF', '2026-05-28', 'finalizado', 9, 'leandro', 1480],
  ['Procuração ad judicia — Construtora Aurora', 'Procuração', 'PDF', '2026-05-12', 'finalizado', 9, 'marina', 320],
  ['Petição inicial · trabalhista Abcesp', 'Petição', 'DOCX', '2026-06-02', 'rascunho', 6, 'leonardo', 2140],
  ['Contrato de Honorários — Helena Vargas', 'Contrato de Honorários', 'DOCX', '2026-06-08', 'revisão', 11, 'leandro', 1247],
  ['Parecer tributário — Atlântico Logística', 'Parecer', 'DOCX', '2026-06-05', 'rascunho', 18, 'thiago', 3900],
  ['Procuração — Inventário Helena Vargas', 'Procuração', 'PDF', '2026-04-30', 'finalizado', 11, 'marina', 310],
  ['Petição · recurso Editora Linhares', 'Petição', 'DOCX', '2026-06-09', 'revisão', 15, 'leonardo', 1820],
  ['Contrato de Honorários — Vértice Capital', 'Contrato de Honorários', 'PDF', '2026-03-15', 'finalizado', 17, 'leonardo', 1390],
  ['Parecer societário — Tech Holding', 'Parecer', 'PDF', '2026-02-20', 'finalizado', 12, 'leandro', 4250],
];
...
function crmBuildStore() {
  ...
  const documentos = CRM_DOCS_RAW.map((r, i) => {
    const [nome, modelo, formato, data, status, cidx, autor, palavras] = r;
    return { id: 'D' + String(i + 1).padStart(3, '0'), nome, modelo, formato, data, status, clienteId: clientes[cidx].id, autor, palavras, numero: 'DOC-2026-0' + (101 + i), multa: false };
  });
