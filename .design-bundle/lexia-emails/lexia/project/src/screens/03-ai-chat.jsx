...
const DocumentPreview = () => (
  <div style={{
    ...
    <div style={{ padding: '20px 40px 10px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(2,13,37,0.1)' }}>
      <div>
        <div style={{ fontFamily: 'Georgia, serif', fontWeight: 500, fontSize: 13, letterSpacing: '0.02em', color: '#020D25' }}>
          MORAES & ASSOCIADOS
        </div>
    ...
    {/* Body */}
    <div style={{ padding: '24px 40px 40px', fontSize: 11, lineHeight: 1.7, color: '#020D25' }}>
      <div style={{ textAlign: 'center', fontWeight: 500, fontSize: 12, letterSpacing: '0.06em', marginBottom: 16 }}>
      ...
      <p style={{ margin: '0 0 10px', textAlign: 'justify' }}>
        ...
        lado, <span style={{ fontWeight: 500 }}>MORAES &amp; ASSOCIADOS SOCIEDADE DE ADVOGADOS</span>, inscrita
        na OAB/SP sob o nº 12.456, doravante denominada CONTRATADA, têm entre
        si justo e contratado o seguinte:
      </p>

      <p style={{ margin: '12px 0 6px', fontWeight: 500, fontSize: 11 }}>
      ...
      <p style={{ margin: '12px 0 6px', fontWeight: 500, fontSize: 11, opacity: 0.45 }}>
    ...
    {suggestion && (
      <div style={{
        ...
        <div style={{ flex: 1, fontSize: 12, color: 'var(--text)', lineHeight: 1.45 }}>
          <div style={{ fontSize: 9.5, fontWeight: 500, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--accent)', marginBottom: 2 }}>
...
const SaveStatus = () => (
  <div style={{
    ...
    fontSize: 12, color: 'var(--text-subtle)', marginRight: 4,
  }}>
